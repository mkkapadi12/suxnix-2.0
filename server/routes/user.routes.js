...
router.patch('/orders/:orderId/cancel', authMiddleware, orderController.cancelOrder);
...
router.get('/wishlist/check/:productId', authMiddleware, wishlistController.isInWishlist);
